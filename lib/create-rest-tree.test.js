...
describe('Create REST Api routing', () => {
  ...
  describe('createExecFunc', () => {
    ...
    test('Basic', () => {
      ...
      expect(fn({ url_params: { id: 1 } })).resolves.toEqual(expectedCtx)
    })
    ...
    describe('Copying of options, hooks and meta', () => {
      ...
      const fn1 = createExecFunc(record1, axiosInstanceMock)
      const fn2 = createExecFunc(record2, axiosInstanceMock)
    ...
    test('Base hook', () => {
      ...
      const fn = createExecFunc(normalizeRecord(record, { meta: {} }), axiosInstanceMock)
    ...
    test('Composition of hook', () => {
      ...
      const fn = createExecFunc(normalizeRecord(record, props), axiosInstanceMock)
